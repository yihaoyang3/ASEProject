    ...
    F.prototype.config = {
            ...
            switch (layui.stope(e), R.trigger("table.tool.panel.remove"), l.close(a.tipsIndex), c) {
                ...
                case"LAYTABLE_PRINT":
                    var h = window.open("打印窗口", "_blank"),
                        f = ["<style>", "body{fonts-size: 12px; color: #666;}", "table{width: 100%; border-collapse: collapse; border-spacing: 0;}", "th,td{line-height: 20px; padding: 9px 15px; border: 1px solid #ccc; text-align: left; fonts-size: 12px; color: #666;}", "a{color: #666; text-decoration:none;}", "*.layui-hide{display: none}", "</style>"].join(""),
        ...
        a.layBody.on("click", "." + g, function (e) {
            ...
            a.tipsIndex = l.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (d.height() + 16) + "px;" + function () {
                return "sm" === o.size ? "padding: 4px 15px; fonts-size: 12px;" : "lg" === o.size ? "padding: 14px 15px;" : ""
